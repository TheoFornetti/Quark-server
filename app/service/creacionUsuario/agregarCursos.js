...
async function agregarCursos(usuario) {
  ...
  const core_enrol_get_users_courses = `${process.env.VM_IP}/webservice/rest/server.php?wstoken=${process.env.TOKEN}&&wsfunction=core_enrol_get_users_courses&userid=${usuario.id}&moodlewsrestformat=json`;
